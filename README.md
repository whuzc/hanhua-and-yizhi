...
> 当前工具版本：`v1.3.7`（修复严格作弊标签批次失败；生成 APK 默认身份仍为 versionCode `8` / versionName `1.3.0`）
> [下载 Windows portable v1.3.7](https://github.com/whuzc/hanhua-and-yizhi/releases/tag/v1.3.7)
